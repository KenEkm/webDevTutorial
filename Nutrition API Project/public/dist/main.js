...
module.exports.search = function search(term) {
  return axios.post("https://api.nal.usda.gov/fdc/v1/search", {
...
module.exports.info = function info(fdcId) {
  return axios.get("https://api.nal.usda.gov/fdc/v1/" + fdcId, {
    auth: auth
  }).then(function (response) {
...
var _require = __webpack_require__(/*! ./api/product */ "./src/api/product.js"),
  search = _require.search,
  info = _require.info;
var testTemplate = __webpack_require__(/*! ./templates/test.ejs */ "./src/templates/test.ejs");
console.log(testTemplate({
  name: "TEST!"
}));
search("Apple").then(function (res) {
